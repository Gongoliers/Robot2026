...
public enum FieldRegion {
    ...
    BLUE_DEPOT_ZONE(ZERO, ZERO, BLUE_HUB_X, Y_MIDLINE, SCORING, PASSING),
    NEUTRAL_ZONE(ZERO, BLUE_HUB_X, WIDTH, LENGTH.minus(BLUE_HUB_X), PASSING, PASSING),
    RED_DEPOT_ZONE(LENGTH.minus(BLUE_HUB_X), ZERO, LENGTH, Y_MIDLINE, PASSING, SCORING),
    RED_OUTPOST_ZONE(LENGTH.minus(BLUE_HUB_X), Y_MIDLINE, LENGTH, Y_MIDLINE, PASSING, SCORING);
